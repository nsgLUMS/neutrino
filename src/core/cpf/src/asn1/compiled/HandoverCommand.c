...
asn_TYPE_member_t asn_MBR_HandoverCommand_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverCommand, protocolIEs),
...
asn_SEQUENCE_specifics_t asn_SPC_HandoverCommand_specs_1 = {
